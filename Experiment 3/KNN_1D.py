...
original_dataset=pd.read_csv("../../First_Exp/IoTDevID_FP_MAIN.csv")
...
classify = KNeighborsClassifier(algorithm='auto', leaf_size=30, metric='minkowski', n_jobs=-1, n_neighbors=31, p=2, weights='distance')
...
main_datasets = ['1-D CNN_.tsv', '1-D CNN_Eth.tsv', '1-D CNN__Eth_no_dst.tsv', '1-D CNN_IP.tsv', '1-D CNN_transport.tsv']
for input in inputs:
